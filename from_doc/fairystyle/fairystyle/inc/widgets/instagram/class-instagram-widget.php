...
class Fairy_Style_Instagram_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		...
		$this->settings           = array(
			...
			'client_id' => array(
				'type'  => 'text',
				'value' => '',
				'label' => esc_html__( 'Client ID', 'fairy_style' ),
			),
			'tag' => array(
				'type'  => 'text',
				'value' => '',
	...
	public function widget( $args, $instance ) {
		...
		if ( empty( $instance['client_id'] ) ) {
			return print $args['before_widget'] . esc_html__( 'Please, enter your Instagram CLIENT ID.', 'fairy_style' ) . $args['after_widget'];
		}
		...
		if ( ! $photos ) {
			return print $args['before_widget'] . esc_html__( 'No photos. Maybe you entered a invalid CLIENT ID or hashtag.', 'fairy_style' ) . $args['after_widget'];
		}
