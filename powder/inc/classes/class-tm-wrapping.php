 ...
 */
add_filter( 'template_include', array( 'powder_Wrapping', 'wrap' ), 99 );
add_filter( 'powder_wrap_base', 'powder_wrap_base_cpts' );
 ...
 */
function powder_template_path() {
	return powder_Wrapping::$main_template;
}
 ...
 */
function powder_template_base() {
	return powder_Wrapping::$base;
}

if ( ! class_exists( 'powder_Wrapping' ) ) {
	...
	class powder_Wrapping {
		...
		/**
		 * Initialize new instance of powder_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'powder_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in powder_Wrapping class.
		 *
		 * @since 4.0.0
 ...
 */
function powder_wrap_base_cpts( $templates ) {
