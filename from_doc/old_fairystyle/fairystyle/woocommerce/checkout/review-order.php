...
<table class="shop_table shop_table_responsive woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			...
			<th class="product-total"><?php _e( 'Total', 'fairy_style' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
			...
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_checkout_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-total" data-title="<?php _e( 'Total', 'fairy_style' ); ?>">
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<th colspan="3"><?php _e( 'Subtotal', 'fairy_style' ); ?></th>
			<td data-title="<?php _e( 'Subtotal', 'fairy_style' ); ?>"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<tr class="order-total">
			<th colspan="3"><?php _e( 'Total', 'fairy_style' ); ?></th>
			<td data-title="<?php _e( 'Total', 'fairy_style' ); ?>"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
