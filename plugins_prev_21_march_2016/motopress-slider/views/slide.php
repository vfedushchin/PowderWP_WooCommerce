...
<?php
    ...
    echo '<button type="button" class="button-primary mpsl-button" id="save_slide">' . __($saveTitle, MPSL_TEXTDOMAIN) . '</button>';
    echo '<button id="slider_preview" class="button-secondary mpsl-button"  data-mpsl-slider-id="'. $this->getSliderId() .'" >' . __('Preview Slide', MPSL_TEXTDOMAIN) . '</button>';
