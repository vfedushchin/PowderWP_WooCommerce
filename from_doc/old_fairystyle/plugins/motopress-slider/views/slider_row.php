...
<tr>
    ...
    <td class="btn-group" role="group">
        ...
        <a class="button-primary" href="<?php echo $slidesEditUrl; ?>"><?php _e($sliderEditTitle, MPSL_TEXTDOMAIN);?></a>
		<?php if ($sliderType != 'custom') { ?>
			<a class="button-link" href="<?php echo $sliderEditUrl . '#mpsl-slider-settings-post_settings'; ?>"><?php _e('Content', MPSL_TEXTDOMAIN);?></a>
        <?php } ?>
		<a class="mpsl-preview-slider-btn button-link" data-mpsl-slider-id="<?php echo $slider['id']; ?>"  href="#"><?php _e('Preview', MPSL_TEXTDOMAIN);?></a>
        <a class="mpsl-duplicate-slider-btn button-link" data-mpsl-slider-id="<?php echo $slider['id']; ?>" href="#"><?php _e('Duplicate', MPSL_TEXTDOMAIN);?></a>
        <a class="mpsl-delete-slider-btn button-link" data-mpsl-slider-id="<?php echo $slider['id']; ?>" href="#"><?php _e('Delete', MPSL_TEXTDOMAIN);?></a>
    </td>
</tr>