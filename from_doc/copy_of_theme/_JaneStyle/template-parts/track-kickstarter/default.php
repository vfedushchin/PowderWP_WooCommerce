...
<div class="tf-tracker-wrap" style="<?php echo $bg_image; ?>">
	<div class="tf-tracker">
		...
		<div class="tf-tracker-item tf-end-time">
			...
			?></span>
			<span class="tf-tracker-label"><?php _e( 'days to go', 'jane_style' ); ?></span>
		</div>
		<?php endif; ?>
