 ...
 */
add_filter( 'template_include', array( 'jane_style_Wrapping', 'wrap' ), 99 );
add_filter( 'jane_style_wrap_base', 'jane_style_wrap_base_cpts' );
 ...
 */
function jane_style_template_path() {
	return jane_style_Wrapping::$main_template;
}
 ...
 */
function jane_style_template_base() {
	return jane_style_Wrapping::$base;
}

if ( ! class_exists( 'jane_style_Wrapping' ) ) {
	...
	class jane_style_Wrapping {
		...
		/**
		 * Initialize new instance of jane_style_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'jane_style_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in jane_style_Wrapping class.
		 *
		 * @since 4.0.0
		...
		public static function wrap( $main ) {
			...
			return new jane_style_Wrapping();
		}
	}
}
 ...
 */
function jane_style_wrap_base_cpts( $templates ) {
