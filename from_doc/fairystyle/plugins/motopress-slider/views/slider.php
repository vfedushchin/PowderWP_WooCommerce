...
<div class="control-panel">
    <?php if (is_null($sliderId)) {
        ...
        echo '<button data-id="' . $sliderId . '" type="button" class="button-primary mpsl-button" id="update_slider">' . __('Save Settings', MPSL_TEXTDOMAIN) . '</button>';
//        echo '<button data-id="' . $sliderId . '" type="button" class="button-secondary mpsl-button" id="delete_slider">' . __('Delete Slider', MPSL_TEXTDOMAIN) . '</button>';

        if($sliderType !== 'custom'){
            echo '<a id="edit_slides_template" class="button-secondary mpsl-button" href="' . add_query_arg(array('view' => 'slide', 'id' => $this->getTemplateId()), menu_page_url($mpsl_settings['plugin_name'], false)) . '">' . __('Edit Template', MPSL_TEXTDOMAIN) . '</a>';
        }else{
            echo '<a id="edit_slides" class="button-secondary mpsl-button" href="' . add_query_arg(array('view' => 'slides', 'id' => $sliderId), menu_page_url($mpsl_settings['plugin_name'], false)) . '">' . __('Edit Slides', MPSL_TEXTDOMAIN) . '</a>';
        }

        echo '<a id="slider_preview" class="button-secondary mpsl-button" href="#" data-mpsl-slider-id="'. $sliderId .'" >' . __('Preview slider', MPSL_TEXTDOMAIN) . '</a>';
