    ...
    <div class="container">
        ...
        <form action="<?php echo admin_url('admin.php?import=mpsl-importer&step=2&action=preset'); ?>" method="POST">
            ...
            <table class="widefat mpsl-templates-table mpsl-templates-group-main">
                <thead>
                <tr>
                   <th colspan="2"><?php _e('Choose Slider Type:', MPSL_TEXTDOMAIN); ?></th>
                </tr>
                </thead>
                <tbody>
            ...
            <table class="widefat mpsl-templates-table mpsl-templates-group-sample">
                <thead>
                <tr>
                    <th colspan="3"><?php _e('Import Sample:', MPSL_TEXTDOMAIN); ?></th>
                </tr>
                </thead>
                <tbody><tr>
            ...
            <div class="mpsl-slider-preset-footer">
                <input id="mpsl-create-slider-preset" type="submit" class="button-primary" value="<?php _e('Create Slider', MPSL_TEXTDOMAIN); ?>">
            </div>
