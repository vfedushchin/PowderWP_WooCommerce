...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'order_item', $item, $order ) ); ?>">
	<td class="product-thumbnail">
		<?php
			$thumbnail = apply_filters( 'woocommerce_cart_item_thumbnail', $product->get_image( 'shop_catalog' ), $cart_item, $cart_item_key );
	...
	<td data-title="<?php _e( 'Quantity', 'fairy_style' ); ?>">
		<?php
