...
<!--                    <a class="button-primary" href="--><?php //echo $this->getSliderCreateUrl(); ?><!--&slider_type=post">--><?php //_e('Create New Post Slider', MPSL_TEXTDOMAIN); ?><!--</a>-->
<!--                    <a class="button-primary" href="--><?php //echo $this->getSliderCreateUrl(); ?><!--&slider_type=woocommerce">--><?php //_e('Create New WooCommerce Slider', MPSL_TEXTDOMAIN); ?><!--</a>-->

                    <button class="button-primary" id="template-btn"><?php _e('Create Slider', MPSL_TEXTDOMAIN); ?></button>
