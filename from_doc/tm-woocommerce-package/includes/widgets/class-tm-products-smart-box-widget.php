...
if ( class_exists( 'WC_Widget_Products' ) ) {
	...
	class __TM_Products_Smart_Box_Widget extends WC_Widget_Products {
		...
		public function form( $instance ) {
			...
			TM_Woocommerce::tm_widgets_form_multiselect( $instance, $this );
		...
		public function widget( $args, $instance ) {
			...
			if ( !in_array( 'all-categories', $instance['tm_filter_by_category'] ) ) {
			...
			$start_html[] = '<section class="woocommerce rd-material-tabs tm-products-smart-box-widget__rd-material-tabs" id="rd-material-tabs-' . $uniqid . '">';
