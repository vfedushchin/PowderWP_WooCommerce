...
//                'options' => $this->pageController->getOptions(),
    ...
    private function getLangStrings(){
        ...
        return array(
            ...
            'template_dialog_title' => __('Create New Slider', MPSL_TEXTDOMAIN),
	        ...
	        'macros' => array(
		        ...
		        'post' => array(
			        'title' => __('The post title', MPSL_TEXTDOMAIN),
					'content' => __('The post content', MPSL_TEXTDOMAIN),
					'excerpt' => __('The post excerpt', MPSL_TEXTDOMAIN),
					'categories' => __('The post categories', MPSL_TEXTDOMAIN),
					'tags' => __('The post tags', MPSL_TEXTDOMAIN),
					'link' => __('The post link', MPSL_TEXTDOMAIN),
					'author_name' => __('The author name', MPSL_TEXTDOMAIN),
					'unique_id' => __('The unique ID of the post', MPSL_TEXTDOMAIN),
					'image' => __('Post image', MPSL_TEXTDOMAIN),
					'image_source' => __('Post image source', MPSL_TEXTDOMAIN),
					'year' => __('The year of the post', MPSL_TEXTDOMAIN),
					'numeric_month' => __('Numeric Month', MPSL_TEXTDOMAIN),
					'month_name' => __('Month name', MPSL_TEXTDOMAIN),
					'day_of_month' => __('Day of the month', MPSL_TEXTDOMAIN),
					'weekday_name' => __('Weekday name', MPSL_TEXTDOMAIN),
					'hour_minutes' => __('Hour:Minutes', MPSL_TEXTDOMAIN),
					'publish_date' => __('The publish date', MPSL_TEXTDOMAIN),
					'last_modified_date' => __('The last modified date', MPSL_TEXTDOMAIN),
					'number_of_comments' => __('Number of comments', MPSL_TEXTDOMAIN)
		        ),
		        'woo' => array(
			        'add_to_cart' => __('Add To Cart', MPSL_TEXTDOMAIN),
					'price' => __('Price', MPSL_TEXTDOMAIN),
					'currency' => __('Currency', MPSL_TEXTDOMAIN),
					'currency_price' => __('Currency + Price', MPSL_TEXTDOMAIN),
					'regular_price' => __('Regular Price', MPSL_TEXTDOMAIN),
					'sale_price' => __('Sale Price', MPSL_TEXTDOMAIN),
					'in_stock_status' => __('In Stock Status', MPSL_TEXTDOMAIN),
			        'in_stock_quantity' => __('In Stock Quantity', MPSL_TEXTDOMAIN),
					'weight' => __('Weight', MPSL_TEXTDOMAIN),
					'product_categories' => __('Product Categories', MPSL_TEXTDOMAIN),
					'product_tags' => __('Product Tags', MPSL_TEXTDOMAIN),
					'total_sales' => __('Total Sales', MPSL_TEXTDOMAIN),
					'average_rating' => __('Average Rating', MPSL_TEXTDOMAIN),
					'rating_count' => __('Rating Count', MPSL_TEXTDOMAIN)
		        )
	        )
        );
    }
        ...
        if ($options) {
            ...
            foreach ($posts as $post) {
	            $_posts[] = array(
		            ...
		            'image' => $db->getPostImageThumbnail($post),
		            'excerpt' => $db->getExcerpt($post, $charLength),
		            'date' => $db->getFormatDate('F j, Y', $post)
	            );
            }
...
//        $slider = new MPSLSliderOptions(array('key' => 'alias', 'value' => $alias));
        ...
        $result = get_mpsl_slider_by_options($sliderOptions, $edit_mode, $mpAtts);
	    MPSLSharing::enableShortcodeRendering();
    }
	return $result;
}

function get_mpsl_slider_by_options($sliderOptions, $edit_mode = false, $mpAtts = array()){
