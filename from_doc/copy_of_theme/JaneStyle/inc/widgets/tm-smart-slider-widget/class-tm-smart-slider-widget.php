...
class __Tm_Smart_Slider_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		$this->widget_cssclass    = 'jane_style widget_smart_slider';
		$this->widget_description = esc_html__( 'Display smart slider on your site.', 'jane_style' );
		$this->widget_id          = 'widget_smart_slider';
		$this->widget_name        = esc_html__( 'Smart Slider Widget', 'jane_style' );
		$this->settings           = array(
			'title' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Smart Slider', 'jane_style' ),
				'label' => esc_html__( 'Title', 'jane_style' ),
			),
			'terms_type' => array(
				'type'    => 'radio',
				'value'   => 'category',
			...
			'categories' => array(
				...
				'options'          => false,
				'label'            => esc_html__( 'Select category', 'jane_style' ),
				'multiple'         => true,
				'placeholder'      => esc_html__( 'Select category', 'jane_style' ),
			...
			'tags' => array(
				...
				'options'          => false,
				'label'            => esc_html__( 'Select tags', 'jane_style' ),
				'multiple'         => true,
				'placeholder'      => esc_html__( 'Select tags', 'jane_style' ),
			...
			'posts_per_page' => array(
				...
				'max_value' => 50,
				'min_value' => 1,
				'label'     => esc_html__( 'Posts count', 'jane_style' ),
			),
			'post_title' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display title', 'jane_style' ),
			),
			'content' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display content', 'jane_style' ),
			),
			'more_button' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display more button', 'jane_style' ),
			),
			'more_button_text' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Read more', 'jane_style' ),
				'label' => esc_html__( 'More button text', 'jane_style' ),
			),
			'trim_words' => array(
				'type'       => 'slider',
				'value'      => 15,
				...
				'min_value'  => 1,
				'step_value' => 1,
				'label'      => esc_html__( 'Content words trimmed count', 'jane_style' ),
			),
			'width' => array(
				'type'  => 'text',
				'value' => '100%',
				'label' => esc_html__( 'Slider width', 'jane_style' ),
			),
			'height' => array(
				'type'  => 'text',
				'value' => '800',
				'label' => esc_html__( 'Slider height', 'jane_style' ),
			),
			'orientation' => array(
				'type'    => 'select',
				'size'    => 1,
				...
				'label' => esc_html__( 'Slider orientation', 'jane_style' ),
			),
			'slide_distance' => array(
				...
				'max_value' => 100,
				'min_value' => 0,
				'label'     => esc_html__( 'Slide distance(px)', 'jane_style' ),
			),
			'slide_duration' => array(
				...
				'min_value'  => 100,
				'step_value' => 100,
				'label'      => esc_html__( 'Slide duration(ms)', 'jane_style' ),
			),
			'slide_fade' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use fade effect?', 'jane_style' ),
			),
			'navigation' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use navigation?', 'jane_style' ),
			),
			'fade_navigation' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Indicates whether the arrows will fade in only on hover', 'jane_style' ),
			),
			'pagination' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use pagination?', 'jane_style' ),
			),
			'autoplay' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use autoplay?', 'jane_style' ),
			),
			'fullScreen' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display fullScreen button?', 'jane_style' ),
			),
			'shuffle' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Indicates if the slides will be shuffled', 'jane_style' ),
			),
			'loop' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Use infinite scrolling?', 'jane_style' ),
			),
			'thumbnails' => array(
				'type'  => 'switcher',
				'value' => 'false',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display thumbnails?', 'jane_style' ),
			),
			'thumbnails_arrows' => array(
				'type'  => 'switcher',
				'value' => 'true',
				'style' => ( wp_is_mobile() ) ? 'normal' : 'small',
				'label' => esc_html__( 'Display thumbnails arrows?', 'jane_style' ),
			),
			'thumbnails_position' => array(
				...
				'value'   => 'bottom',
				'options' => array(
					'top'    => esc_html__( 'Top', 'jane_style' ),
					'bottom' => esc_html__( 'Bottom', 'jane_style' ),
					'right'  => esc_html__( 'Right', 'jane_style' ),
					'left'   => esc_html__( 'Left', 'jane_style' ),
				),
				'label' => esc_html__( 'Sets the position of the thumbnail scroller', 'jane_style' ),
			),
		);
	...
	public function widget( $args, $instance ) {
		...
		if ( $posts_query ) {
			...
			$html = '<h4>' . esc_html__( 'Posts for slider not found', 'jane_style' ) . '</h4>';
		}
	...
	public function render_slider( $posts_query ) {
		...
		$html = '<div class="jane_style-smartslider" ' . $slider_html_attr . '>';
			$html .= '<div id="' . $uniq_id . '" class="jane_style-smartslider__instance slider-pro">';
				$html .= '<div class="jane_style-smartslider__slides sp-slides">';
					$html .= $this->get_slider_loop( $posts_query );
				$html .= '</div>';

				if ( 'true' == $this->instance['thumbnails'] ) {
					$html .= '<div class="jane_style-smartslider__thumbnails sp-thumbnails">';
	...
	public function get_query_slider_items( $query_args = array() ) {
		...
		$defaults_query_args = apply_filters( 'jane_style_smart_slider_default_query_args', array(
			'post_type'      => 'post',
			'orderby'        => 'date',
			'order'          => 'DESC',
			'posts_per_page' => -1,
	...
	public function get_slider_loop( $posts_query ) {
		 ...
		 * @var  array
		 */
		$title_settings = apply_filters( 'jane_style_smart_slider_title_settings', array(
		 ...
		 * @var  array
		 */
		$content_settings = apply_filters( 'jane_style_smart_slider_content_settings', array(
		 ...
		 * @var  array
		 */
		$more_settings = apply_filters( 'jane_style_smart_slider_more_button_settings', array(
		...
		$placeholder_args = apply_filters( 'jane_style_smart_slider_placeholder_args', array(
			'width'  => 1600,
	...
	public function get_slider_thumbnails( $posts_query ) {
		...
		$thumbnail_size = apply_filters( 'jane_style_smart_slider_thumbnail_size', 'jane_style-thumb-240-100', $this->instance );
	...
	public function get_image( $id, $size, $placeholder_attr, $only_url = false ) {
		...
		if ( has_post_thumbnail( $id ) ) {
			...
			$default_placeholder_attr = apply_filters( 'jane_style_smart_slider_placeholder_default_args', array(
				'width'      => 900,
				'height'     => 500,
				'background' => 'eef4fa',
				'foreground' => '298ffc',
...
add_action( 'widgets_init', 'jane_style_register_smart_slider_widgets' );
function jane_style_register_smart_slider_widgets() {
