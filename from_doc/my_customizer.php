...
function jane_style_get_default_top_panel_text() {
	return sprintf(
		__( 'Call us: <em>+3(800) 2345-6789</em> 7 Days a week from 9:00 am to 7:00 pm', 'jane_style' )
	);
}
...
function jane_style_get_default_footer_copyright() {
	return 'POWDER is proudly powered by WordPress Entries (RSS) and Comments (RSS) <a href="#">Privacy Policy</a>';
}
