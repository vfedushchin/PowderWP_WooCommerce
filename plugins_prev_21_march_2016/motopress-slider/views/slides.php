            ...
            <?php
                ...
                foreach($slides as $slide) {
                    ...
                    <tr data-id="<?php echo $slide['id'] ?>">
                        ...
                        <td class="mpsl-slide-name-wrapper"><a class="mpsl-slide-name" href="<?php echo $slideEditUrl; ?>"><?php echo ($slide['title']) ? $slide['title'] : '<i>' . __('not set', MPSL_TEXTDOMAIN) . '</i>';?></a></td>
                        ...
                        <td class="btn-group" role="group">
                            ...
                            <a class="mpsl_duplicate_slide button-link" data-id="<?php echo $slide['id'] ?>" href="#"><?php _e('Duplicate', MPSL_TEXTDOMAIN); ?></button>
                            <a class="mpsl_delete_slide button-link" data-id="<?php echo $slide['id'] ?>" href="#"><?php _e('Delete', MPSL_TEXTDOMAIN); ?></button>
                        </td>
                    </tr>
                    <?php
                }
