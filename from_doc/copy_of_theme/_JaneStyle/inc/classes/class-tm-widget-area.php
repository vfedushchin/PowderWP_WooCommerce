...
if ( ! class_exists( 'jane_style_Widget_Area' ) ) {
	class jane_style_Widget_Area {
		/**
		...
		*/
		function __construct( $widgets_settings = array() ) {
			$widgets_default_settings = apply_filters( 'tm_widget_area_default_settings', array(
				'sidebar-primary' => array(
					'name'           => esc_html__( 'Sidebar Primary', 'jane_style' ),
					'description'    => '',
				...
				'sidebar-secondary' => array(
					'name'           => esc_html__( 'Sidebar Secondary', 'jane_style' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'full-width-header-area' => array(
					'name'           => esc_html__( 'Full width header area', 'jane_style' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'before-content-area' => array(
					'name'           => esc_html__( 'Before content widget area', 'jane_style' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'before-loop-area' => array(
					'name'           => esc_html__( 'Before loop widget area', 'jane_style' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'after-loop-area' => array(
					'name'           => esc_html__( 'After loop widget area', 'jane_style' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'after-content-area' => array(
					'name'           => esc_html__( 'After content widget area', 'jane_style' ),
					'description'    => '',
				...
				'after-content-full-width-area' => array(
					'name'           => esc_html__( 'After content full width widget area', 'jane_style' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
				...
				'footer-area' => array(
					'name'           => esc_html__( 'Footer widget area', 'jane_style' ),
					'description'    => '',
					'before_widget'  => '<aside id="%1$s" class="widget %2$s">',
					'after_widget'   => '</aside>',
					'before_title'   => '<h4 class="widget-title">',
			...
			add_action( 'jane_style_render_widget_area', array( $this, 'render_widget_area' ) );
		}
		/**
		 * Register sidebars.
		 *
		...
		public function render_widget_area( $area_id ) {
			...
			$area_id        = apply_filters( 'jane_style_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'jane_style_widget_area_classes', $classes, $area_id );
			if ( is_array( $classes ) ) {
	...
	function jane_style_widget_area() {
		return jane_style_Widget_Area::get_instance();
	}
	jane_style_widget_area();
}